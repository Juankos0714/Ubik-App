...
import * as i2 from "../../../../core/services/register-user-est.service";
import * as i3 from "@angular/router";
function RegisterOwner_Conditional_14_Template(rf, ctx) { if (rf & 1) {
...
function RegisterOwner_Conditional_17_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 12);
    i0.ɵɵtext(1, " Este nombre de usuario ya est\u00E1 en uso. ");
    i0.ɵɵelementEnd();
} }
function RegisterOwner_Conditional_19_Template(rf, ctx) { if (rf & 1) {
...
function RegisterOwner_Conditional_21_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 14);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function RegisterOwner_Conditional_25_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 14);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function RegisterOwner_Conditional_27_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 14);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function RegisterOwner_Conditional_29_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 14);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function RegisterOwner_Conditional_33_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "span", 25);
    i0.ɵɵtext(1, " Obteniendo... ");
} }
function RegisterOwner_Conditional_34_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span", 26);
    i0.ɵɵtext(1, " \u2713 ");
    i0.ɵɵelementEnd();
    i0.ɵɵtext(2, " Ubicaci\u00F3n correcta ");
} }
function RegisterOwner_Conditional_35_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵtext(0, " Obtener ubicaci\u00F3n actual ");
} }
function RegisterOwner_Conditional_36_Template(rf, ctx) { if (rf & 1) {
...
function RegisterOwner_Conditional_37_Template(rf, ctx) { if (rf & 1) {
...
function RegisterOwner_Conditional_39_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵtext(0, " Registrando... ");
} }
function RegisterOwner_Conditional_40_Template(rf, ctx) { if (rf & 1) {
...
export class RegisterOwner {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: RegisterOwner, selectors: [["app-register-propertyEst"]], decls: 41, vars: 17, consts: [[1, "mb-28", "mt-28", "flex", "items-center", "justify-center"], [1, "w-full", "max-w-md", "bg-white/10", "backdrop-blur-md", "rounded-2xl", "shadow-2xl", "p-8", "border", "border-white/20"], [1, "flex", "items-center", "justify-center", "px-5", "text-white"], [1, "w-full", "max-w-md"], [1, "text-4xl", "font-bold", "mb-6", "tracking-wider", "text-center"], [1, "mb-4"], [1, "flex", "justify-between", "text-xs", "opacity-70", "mb-1"], [1, "w-full", "h-2", "bg-white/10", "rounded-full", "overflow-hidden"], [1, "h-2", "bg-red-600", "rounded-full"], [1, "mb-4", "rounded-lg", "border", "border-red-500/40", "bg-red-500/10", "px-4", "py-3", "text-sm", "text-red-200"], [1, "flex", "flex-col", "gap-3", 3, "ngSubmit", "formGroup"], ["label", "Nombre de Usuario", "placeholder", "Ingrese su nombre de usuario", "type", "text", "formControlName", "username"], [1, "text-xs", "text-red-300", "-mt-3"], ["label", "Correo electr\u00F3nico", "placeholder", "Ingrese su correo", "type", "email", "formControlName", "email"], [1, "text-red-300", "text-xs", "-mt-1"], ["label", "N\u00FAmero de tel\u00E9fono", "placeholder", "Ingrese su n\u00FAmero de tel\u00E9fono", "type", "tel", "formControlName", "phoneNumber"], [1, "mb-1", "text-white", "text-sm"], ["type", "date", "formControlName", "birthDate", 1, "rounded-full", "p-3", "text-black", "focus:outline-none", "focus:ring-2", "focus:ring-red-600", "w-full", "bg-white", "text-center"], ["label", "Contrase\u00F1a", "formControlName", "password", "placeholder", "Ingrese su contrase\u00F1a", "type", "password"], ["label", "Confirmar contrase\u00F1a", "formControlName", "comfirmPassword", "placeholder", "Confirme su contrase\u00F1a", "type", "password"], [1, "mb-1", "text-white", "text-base"], ["type", "button", 1, "inline-flex", "items-center", "justify-center", "rounded-xl", "border", "border-white/15", "bg-white/5", "px-4", "py-3", "text-sm", "font-medium", "text-white/90", "hover:bg-white/10", "active:scale-[0.99]", "transition", "disabled:opacity-50", "disabled:cursor-not-allowed", 3, "click", "disabled"], [1, "mt-1", "text-xs", "text-white/70"], [1, "mt-1", "text-xs", "text-red-300"], ["type", "submit", 1, "bg-linear-to-r", "from-[#6E2A35]", "to-[#A72027]", "text-white", "font-medium", "rounded-lg", "text-center", "hover:from-[#7E3A45]", "hover:to-[#B73037]", "transition-colors", "cursor-pointer", "justify-between", "gap-2", "p-2.5", "text-overflow:", "ellipsis;", "text-clip", 3, "disabled"], [1, "mr-2", "inline-block", "h-4", "w-4", "animate-spin", "rounded-full", "border-2", "border-white/30", "border-t-white"], [1, "mr-2", "inline-flex", "h-5", "w-5", "items-center", "justify-center", "rounded-full", "border", "border-white/30"]], template: function RegisterOwner_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵelementEnd()();
            i0.ɵɵconditionalCreate(14, RegisterOwner_Conditional_14_Template, 2, 1, "div", 9);
            i0.ɵɵelementStart(15, "form", 10);
            i0.ɵɵlistener("ngSubmit", function RegisterOwner_Template_form_ngSubmit_15_listener() { return ctx.onSubmit(); });
            i0.ɵɵelement(16, "app-input", 11);
            i0.ɵɵconditionalCreate(17, RegisterOwner_Conditional_17_Template, 2, 0, "p", 12);
            i0.ɵɵelement(18, "app-input", 13);
            i0.ɵɵconditionalCreate(19, RegisterOwner_Conditional_19_Template, 2, 1, "p", 14);
            i0.ɵɵelement(20, "app-input", 15);
            i0.ɵɵconditionalCreate(21, RegisterOwner_Conditional_21_Template, 2, 1, "p", 14);
            i0.ɵɵelementStart(22, "label", 16);
            i0.ɵɵtext(23, "Fecha de nacimiento");
            i0.ɵɵelementEnd();
            i0.ɵɵelement(24, "input", 17);
            i0.ɵɵconditionalCreate(25, RegisterOwner_Conditional_25_Template, 2, 1, "p", 14);
            i0.ɵɵelement(26, "app-input", 18);
            i0.ɵɵconditionalCreate(27, RegisterOwner_Conditional_27_Template, 2, 1, "p", 14);
            i0.ɵɵelement(28, "app-input", 19);
            i0.ɵɵconditionalCreate(29, RegisterOwner_Conditional_29_Template, 2, 1, "p", 14);
            i0.ɵɵelementStart(30, "label", 20);
            i0.ɵɵtext(31, "Ubicaci\u00F3n");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(32, "button", 21);
            i0.ɵɵlistener("click", function RegisterOwner_Template_button_click_32_listener() { return ctx.getUserLocation(); });
            i0.ɵɵconditionalCreate(33, RegisterOwner_Conditional_33_Template, 2, 0)(34, RegisterOwner_Conditional_34_Template, 3, 0)(35, RegisterOwner_Conditional_35_Template, 1, 0);
            i0.ɵɵelementEnd();
            i0.ɵɵconditionalCreate(36, RegisterOwner_Conditional_36_Template, 2, 1, "p", 22);
            i0.ɵɵconditionalCreate(37, RegisterOwner_Conditional_37_Template, 2, 1, "p", 23);
            i0.ɵɵelementStart(38, "button", 24);
            i0.ɵɵconditionalCreate(39, RegisterOwner_Conditional_39_Template, 1, 0)(40, RegisterOwner_Conditional_40_Template, 1, 0);
            i0.ɵɵelementEnd()()()()()();
        } if (rf & 2) {
            let tmp_4_0;
            i0.ɵɵadvance(11);
