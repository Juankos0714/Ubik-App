...
export class RegisterServiceOwner {
    ...
    static ɵfac = function RegisterServiceOwner_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || RegisterServiceOwner)(i0.ɵɵinject(i1.HttpClient)); };
    static ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: RegisterServiceOwner, factory: RegisterServiceOwner.ɵfac, providedIn: 'root' });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(RegisterServiceOwner, [{
        type: Injectable,
