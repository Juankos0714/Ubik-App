...
import com.ubik.usermanagement.infrastructure.adapter.out.persistence.repository.MotelImageR2dbcRepository;
...
public class MotelPersistenceAdapter implements MotelRepositoryPort {
    ...
    public Mono<Motel> update(Motel motel) {
        return Mono.just(motel)
                ...
                .flatMap(motelR2dbcRepository::save)
                .flatMap(savedEntity ->
                        motelImageRepository.deleteByMotelId(savedEntity.id())
    ...
    public Mono<Void> deleteById(Long id) {
        return motelImageRepository.deleteByMotelId(id)
     ...
     */
    private Mono<Motel> loadMotelWithImages(com.ubik.usermanagement.infrastructure.adapter.out.persistence.entity.MotelEntity entity) {
        return motelImageRepository.findByMotelIdOrderByDisplayOrder(entity.id())
