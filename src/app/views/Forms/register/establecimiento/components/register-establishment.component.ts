    ...
    <div class="register-wrapper">
      <div class="register-card">
        ...
        <form [formGroup]="form" (ngSubmit)="submit()">
          ...
          <fieldset>
            ...
            <div class="row">
              <div class="field">
                ...
                <span
                  class="err"
                  *ngIf="f['ownerDocumentType'].touched && f['ownerDocumentType'].invalid"
                  >Requerido</span
                >
              </div>
              <div class="field">
                ...
                <span
                  class="err"
                  *ngIf="f['ownerDocumentNumber'].touched && f['ownerDocumentNumber'].invalid"
                  >Requerido</span
                >
              </div>
            </div>
            ...
            <div class="field">
              ...
              <span class="err" *ngIf="f['ownerFullName'].touched && f['ownerFullName'].invalid"
                >Requerido</span
              >
            </div>
          ...
          <!-- ══════════ SUBMIT ══════════ -->
          <div class="actions">
            <button type="submit" class="btn-primary" [disabled]="loading || hasUploadingImages">
